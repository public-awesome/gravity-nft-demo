 ...
 * -------------
 */
export interface MsgSendERC721ToCosmosClaim {
  eventNonce: Long;
  ethBlockHeight: Long;
  tokenContract: string;
  tokenId: string;
 ...
 * -------------
 */
export interface MsgSendERC721ToCosmosClaimSDKType {
  event_nonce: Long;
  eth_block_height: Long;
  token_contract: string;
  token_id: string;
...
export interface MsgSendERC721ToCosmosClaimResponse {}
export interface MsgSendERC721ToCosmosClaimResponseSDKType {}
/**
...
function createBaseMsgSendERC721ToCosmosClaim(): MsgSendERC721ToCosmosClaim {
  return {
    eventNonce: Long.UZERO,
    ethBlockHeight: Long.UZERO,
    tokenContract: "",
...
export const MsgSendERC721ToCosmosClaim = {
  encode(message: MsgSendERC721ToCosmosClaim, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.eventNonce.isZero()) {
      writer.uint32(8).uint64(message.eventNonce);
    }
    if (!message.ethBlockHeight.isZero()) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgSendERC721ToCosmosClaim {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSendERC721ToCosmosClaim();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgSendERC721ToCosmosClaim {
    return {
      eventNonce: isSet(object.eventNonce) ? Long.fromValue(object.eventNonce) : Long.UZERO,
      ethBlockHeight: isSet(object.ethBlockHeight) ? Long.fromValue(object.ethBlockHeight) : Long.UZERO,
      tokenContract: isSet(object.tokenContract) ? String(object.tokenContract) : "",
  ...
  toJSON(message: MsgSendERC721ToCosmosClaim): unknown {
    const obj: any = {};
    message.eventNonce !== undefined && (obj.eventNonce = (message.eventNonce || Long.UZERO).toString());
    message.ethBlockHeight !== undefined && (obj.ethBlockHeight = (message.ethBlockHeight || Long.UZERO).toString());
    message.tokenContract !== undefined && (obj.tokenContract = message.tokenContract);
  ...
  fromPartial(object: Partial<MsgSendERC721ToCosmosClaim>): MsgSendERC721ToCosmosClaim {
    const message = createBaseMsgSendERC721ToCosmosClaim();
    message.eventNonce = object.eventNonce !== undefined && object.eventNonce !== null ? Long.fromValue(object.eventNonce) : Long.UZERO;
    message.ethBlockHeight = object.ethBlockHeight !== undefined && object.ethBlockHeight !== null ? Long.fromValue(object.ethBlockHeight) : Long.UZERO;
    message.tokenContract = object.tokenContract ?? "";
...
function createBaseMsgSendERC721ToCosmosClaimResponse(): MsgSendERC721ToCosmosClaimResponse {
  return {};
}
export const MsgSendERC721ToCosmosClaimResponse = {
  encode(_: MsgSendERC721ToCosmosClaimResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgSendERC721ToCosmosClaimResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSendERC721ToCosmosClaimResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgSendERC721ToCosmosClaimResponse {
    return {};
  },
  toJSON(_: MsgSendERC721ToCosmosClaimResponse): unknown {
    const obj: any = {};
    return obj;
  },
  fromPartial(_: Partial<MsgSendERC721ToCosmosClaimResponse>): MsgSendERC721ToCosmosClaimResponse {
    const message = createBaseMsgSendERC721ToCosmosClaimResponse();
    return message;
  }
};
