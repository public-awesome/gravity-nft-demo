...
export interface MsgSendERC721ToCosmosClaimAminoType extends AminoMsg {
  type: "/gravity.v1.MsgSendERC721ToCosmosClaim";
  value: {
    event_nonce: string;
    eth_block_height: string;
    token_contract: string;
...
export const AminoConverter = {
  ...
  "/gravity.v1.MsgSendERC721ToCosmosClaim": {
    aminoType: "/gravity.v1.MsgSendERC721ToCosmosClaim",
    toAmino: ({
      eventNonce,
      ethBlockHeight,
      tokenContract,
      ...
      cosmosReceiver,
      orchestrator
    }: MsgSendERC721ToCosmosClaim): MsgSendERC721ToCosmosClaimAminoType["value"] => {
      return {
        event_nonce: eventNonce.toString(),
        eth_block_height: ethBlockHeight.toString(),
        token_contract: tokenContract,
    ...
    fromAmino: ({
      ...
      cosmos_receiver,
      orchestrator
    }: MsgSendERC721ToCosmosClaimAminoType["value"]): MsgSendERC721ToCosmosClaim => {
      return {
        eventNonce: Long.fromString(event_nonce),
        ethBlockHeight: Long.fromString(eth_block_height),
        tokenContract: token_contract,
