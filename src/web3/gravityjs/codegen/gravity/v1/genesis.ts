...
import { Valset, ValsetSDKType, ERC20ToDenom, ERC20ToDenomSDKType, PendingIbcAutoForward, PendingIbcAutoForwardSDKType, PendingERC721IbcAutoForward, PendingERC721IbcAutoForwardSDKType } from "./types";
...
export interface Params {
  ...
  bridgeErc721EthereumAddress: string;
}
/**
 * The slashing fractions for the various gravity related slashing conditions. The first three
 * refer to not submitting a particular message, the third for submitting a different claim
...
export interface ParamsSDKType {
  ...
  bridge_erc721_ethereum_address: string;
}
...
export interface GenesisState {
  ...
  erc721Attestations: Attestation[];
}
/** GenesisState struct, containing all persistant data required by the Gravity module */
export interface GenesisStateSDKType {
  ...
  erc721_attestations: AttestationSDKType[];
}
...
export interface GravityNoncesSDKType {
  ...
  last_batch_id: Long;
  last_erc721_observed_nonce: Long;
}
...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.bridgeErc721EthereumAddress !== "") {
      writer.uint32(170).string(message.bridgeErc721EthereumAddress);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 20:
          ...
          break;
        case 21:
          message.bridgeErc721EthereumAddress = reader.string();
          break;
        default:
  ...
  fromJSON(object: any): Params {
    return {
      ...
      bridgeErc721EthereumAddress: isSet(object.bridgeErc721EthereumAddress) ? String(object.bridgeErc721EthereumAddress) : ""
    };
  },
  toJSON(message: Params): unknown {
    ...
    message.bridgeErc721EthereumAddress !== undefined && (obj.bridgeErc721EthereumAddress = message.bridgeErc721EthereumAddress);
    return obj;
  },
  fromPartial(object: Partial<Params>): Params {
    ...
    message.bridgeErc721EthereumAddress = object.bridgeErc721EthereumAddress ?? "";
    return message;
  }
};
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.pendingErc721IbcAutoForwards) {
      PendingERC721IbcAutoForward.encode(v!, writer.uint32(114).fork()).ldelim();
    }
    for (const v of message.erc721Attestations) {
      Attestation.encode(v!, writer.uint32(122).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14:
          ...
          break;
        case 15:
          message.erc721Attestations.push(Attestation.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      erc721Attestations: Array.isArray(object?.erc721Attestations) ? object.erc721Attestations.map((e: any) => Attestation.fromJSON(e)) : []
    };
  },
  toJSON(message: GenesisState): unknown {
    ...
    if (message.erc721Attestations) {
      obj.erc721Attestations = message.erc721Attestations.map(e => e ? Attestation.toJSON(e) : undefined);
    } else {
      obj.erc721Attestations = [];
    }
    return obj;
  },
  fromPartial(object: Partial<GenesisState>): GenesisState {
    ...
    message.erc721Attestations = object.erc721Attestations?.map(e => Attestation.fromPartial(e)) || [];
    return message;
  }
};
function createBaseGravityNonces(): GravityNonces {
  return {
    ...
    lastErc721ObservedNonce: Long.UZERO
  };
}
export const GravityNonces = {
  encode(message: GravityNonces, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (!message.lastErc721ObservedNonce.isZero()) {
      writer.uint32(64).uint64(message.lastErc721ObservedNonce);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          break;
        case 8:
          message.lastErc721ObservedNonce = (reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): GravityNonces {
    return {
      ...
      lastErc721ObservedNonce: isSet(object.lastErc721ObservedNonce) ? Long.fromValue(object.lastErc721ObservedNonce) : Long.UZERO
    };
  },
  toJSON(message: GravityNonces): unknown {
    ...
    message.lastErc721ObservedNonce !== undefined && (obj.lastErc721ObservedNonce = (message.lastErc721ObservedNonce || Long.UZERO).toString());
    return obj;
  },
  fromPartial(object: Partial<GravityNonces>): GravityNonces {
    ...
    message.lastErc721ObservedNonce = object.lastErc721ObservedNonce !== undefined && object.lastErc721ObservedNonce !== null ? Long.fromValue(object.lastErc721ObservedNonce) : Long.UZERO;
    return message;
  }
};