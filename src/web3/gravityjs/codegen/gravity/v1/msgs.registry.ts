...
import { MsgValsetConfirm, MsgSendToEth, MsgRequestBatch, MsgConfirmBatch, MsgConfirmLogicCall, MsgSendToCosmosClaim, MsgSendERC721ToCosmosClaim, MsgExecuteIbcAutoForwards, MsgBatchSendToEthClaim, MsgValsetUpdatedClaim, MsgERC20DeployedClaim, MsgLogicCallExecutedClaim, MsgSetOrchestratorAddress, MsgCancelSendToEth, MsgSubmitBadSignatureEvidence } from "./msgs";
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/gravity.v1.MsgValsetConfirm", MsgValsetConfirm], ["/gravity.v1.MsgSendToEth", MsgSendToEth], ["/gravity.v1.MsgRequestBatch", MsgRequestBatch], ["/gravity.v1.MsgConfirmBatch", MsgConfirmBatch], ["/gravity.v1.MsgConfirmLogicCall", MsgConfirmLogicCall], ["/gravity.v1.MsgSendToCosmosClaim", MsgSendToCosmosClaim], ["/gravity.v1.MsgSendERC721ToCosmosClaim", MsgSendERC721ToCosmosClaim], ["/gravity.v1.MsgExecuteIbcAutoForwards", MsgExecuteIbcAutoForwards], ["/gravity.v1.MsgBatchSendToEthClaim", MsgBatchSendToEthClaim], ["/gravity.v1.MsgValsetUpdatedClaim", MsgValsetUpdatedClaim], ["/gravity.v1.MsgERC20DeployedClaim", MsgERC20DeployedClaim], ["/gravity.v1.MsgLogicCallExecutedClaim", MsgLogicCallExecutedClaim], ["/gravity.v1.MsgSetOrchestratorAddress", MsgSetOrchestratorAddress], ["/gravity.v1.MsgCancelSendToEth", MsgCancelSendToEth], ["/gravity.v1.MsgSubmitBadSignatureEvidence", MsgSubmitBadSignatureEvidence]];
...
export const MessageComposer = {
  encoded: {
    ...
    sendERC721ToCosmosClaim(value: MsgSendERC721ToCosmosClaim) {
      return {
        typeUrl: "/gravity.v1.MsgSendERC721ToCosmosClaim",
        value: MsgSendERC721ToCosmosClaim.encode(value).finish()
      };
    },
  ...
  toJSON: {
    ...
    sendERC721ToCosmosClaim(value: MsgSendERC721ToCosmosClaim) {
      return {
        typeUrl: "/gravity.v1.MsgSendERC721ToCosmosClaim",
        value: MsgSendERC721ToCosmosClaim.toJSON(value)
      };
    },
    executeIbcAutoForwards(value: MsgExecuteIbcAutoForwards) {
      return {
  ...
  fromJSON: {
    ...
    sendERC721ToCosmosClaim(value: any) {
      return {
        typeUrl: "/gravity.v1.MsgSendERC721ToCosmosClaim",
        value: MsgSendERC721ToCosmosClaim.fromJSON(value)
      };
    },
  ...
  fromPartial: {
    ...
    sendERC721ToCosmosClaim(value: MsgSendERC721ToCosmosClaim) {
      return {
        typeUrl: "/gravity.v1.MsgSendERC721ToCosmosClaim",
        value: MsgSendERC721ToCosmosClaim.fromPartial(value)
      };
    },
    executeIbcAutoForwards(value: MsgExecuteIbcAutoForwards) {
      return {
