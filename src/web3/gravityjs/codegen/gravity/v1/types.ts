...
export interface PendingERC721IbcAutoForward {
  /** the destination address. sdk.AccAddress does not preserve foreign prefixes */
  foreignReceiver: string;
...
export interface PendingERC721IbcAutoForwardSDKType {
  foreign_receiver: string;
  class_id: string;
  token_id: string;
  ibc_channel: string;
...
function createBasePendingERC721IbcAutoForward(): PendingERC721IbcAutoForward {
  return {
    foreignReceiver: "",
    classId: "",
    tokenId: "",
...
export const PendingERC721IbcAutoForward = {
  encode(message: PendingERC721IbcAutoForward, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.foreignReceiver !== "") {
      writer.uint32(10).string(message.foreignReceiver);
    }
    if (message.classId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PendingERC721IbcAutoForward {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePendingERC721IbcAutoForward();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): PendingERC721IbcAutoForward {
    return {
      foreignReceiver: isSet(object.foreignReceiver) ? String(object.foreignReceiver) : "",
  ...
  toJSON(message: PendingERC721IbcAutoForward): unknown {
    const obj: any = {};
    message.foreignReceiver !== undefined && (obj.foreignReceiver = message.foreignReceiver);
  ...
  fromPartial(object: Partial<PendingERC721IbcAutoForward>): PendingERC721IbcAutoForward {
    const message = createBasePendingERC721IbcAutoForward();
    message.foreignReceiver = object.foreignReceiver ?? "";
