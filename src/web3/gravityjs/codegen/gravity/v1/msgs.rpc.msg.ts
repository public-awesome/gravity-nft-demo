...
export interface Msg {
  ...
  sendERC721ToCosmosClaim(request: MsgSendERC721ToCosmosClaim): Promise<MsgSendERC721ToCosmosClaimResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    ...
    this.sendERC721ToCosmosClaim = this.sendERC721ToCosmosClaim.bind(this);
  ...
  sendERC721ToCosmosClaim(request: MsgSendERC721ToCosmosClaim): Promise<MsgSendERC721ToCosmosClaimResponse> {
    const data = MsgSendERC721ToCosmosClaim.encode(request).finish();
    const promise = this.rpc.request("gravity.v1.Msg", "SendERC721ToCosmosClaim", data);
    return promise.then(data => MsgSendERC721ToCosmosClaimResponse.decode(new _m0.Reader(data)));
  }
  executeIbcAutoForwards(request: MsgExecuteIbcAutoForwards): Promise<MsgExecuteIbcAutoForwardsResponse> {
